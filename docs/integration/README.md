...
- [书源保存与状态持久化](../workflows/source-persistence-flow.md)：应用如何把 package 产物保存到当前用户。
- [书源检测流程](../workflows/source-check-flow.md)：应用如何组织异步检测任务。
- [Supabase 与存储](../operations/storage-and-supabase.md)：Vercel/Next.js/Node 部署下的持久化边界。
