...
| `source_check_states` | `user_id`, `source_id`, `session_id`, `source_revision`, `check_revision`, status, summary, stage results, timestamps | 见[检测状态](../standard/source-check-state.md)；旧结果条件写入 |
