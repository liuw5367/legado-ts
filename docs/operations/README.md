...
- [存储与 Supabase](storage-and-supabase.md)：用户书源、运行状态、秘密和数据库适配边界。
- [任务执行与 Serverless 边界](job-and-execution.md)：JobStore、Node Worker、租约、幂等和长任务恢复。
- [package 维护与迁移证据](package-maintenance.md)：源码基线、版本、发布、上游变更、许可记录和回退。

应用框架的调用组织见 [使用指南](../guides/README.md)；阶段 E-1/E-2 的实施顺序见 [实施方案](../implementation/README.md)。
